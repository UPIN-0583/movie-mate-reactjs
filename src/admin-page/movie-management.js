    ...
    return (
        <div className="bg-gray-800 p-4 rounded-md">
            ...
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-gray-200 text-xl font-semibold">Movie Management</h2>
            </div>
                    ...
                    {isFetching ? (
                        ...
                        movieList?.map((movie, index) => (
                            ...
                            >
                                ...
                                <td colSpan="2" className="py-2 px-4">{movie.name}</td>
                                <td colSpan="2" className="py-2 px-4 col-span-2">{movie.genre}</td>
                                <td className="py-2 px-4">{movie.duration}</td>
                                <td className="py-2 px-4">{movie.origin}</td>
                                <td className="py-2 px-4">{movie.language}</td>
                                <td className="py-2 px-4">{movie.classify}</td>
                                <td className="py-2 px-4">{movie.director}</td>
                                <td className="py-2 px-4">{movie.actor}</td>
                                <td className="py-2 px-4">{movie.opening}</td>
                                <td colSpan="3" className="py-2 px-4">{movie.description}</td>
                                ...
                                <td className="py-2 px-4">{movie.status}</td>
                                <td className="py-2 px-4">
                                    <button
